<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-r from-indigo-100 to-blue-100 px-4">
    <div class="bg-white shadow-2xl rounded-xl p-8 w-full max-w-md animate-fade-in">
      <h2 class="text-3xl font-bold text-center mb-6 text-gray-800">SHOP</h2>
      ...
      <p class="mt-6 text-sm text-center text-gray-600">
        Já tem conta?
        <router-link to="/login" class="text-blue-600 hover:underline font-semibold">Entrar</router-link>
      </p>
    </div>
  </div>
</template>
